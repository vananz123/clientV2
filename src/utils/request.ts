...
export const post = async (path: string, data: FormData | undefined, options: object = {}) => {
    const response = await request.post(path, data, options);
    return response.data;
};
export const put = async (path: string, data: FormData | undefined, options: object = {}) => {
    const response = await request.put(path, data, options);
    return response.data;
};
export const patch = async (path: string, data: FormData | undefined, options: object = {}) => {
